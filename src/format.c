...
instr_args_t op_argsformat[256] =
{
    ...
    ARGS_ERR,
    /* 1x */
    ARGS_I, ARGS_R_R_I, ARGS_R_I, ARGS_R_R_I, ARGS_I, ARGS_NONE, ARGS_R,
    ARGS_R_I, ARGS_R,
    ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR,
    /* 2x */
    ARGS_R_I, ARGS_SP_I, ARGS_R_I, ARGS_R_R, ARGS_R_R,
    ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR,
    ...
    ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR,
    /* Ax */
    ARGS_R_I, ARGS_R_R, ARGS_R_R_R, ARGS_R_I, ARGS_R_R, ARGS_R_R_R, ARGS_R_I,
    ARGS_R_R, ARGS_R_R_R,
    ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR,
    /* Bx */
    ...
    ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR,
    /* Ex */
    ARGS_R_I, ARGS_R, ARGS_R_R, ARGS_R_I, ARGS_R, ARGS_R_R,
    ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR,
    ARGS_ERR, ARGS_ERR, ARGS_ERR,
    /* Fx */
    ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR, ARGS_ERR,
